...
HD_PWD='C:/Users/vince/Desktop/Vivado/motor_test/motor_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log servo_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source servo_top.tcl
