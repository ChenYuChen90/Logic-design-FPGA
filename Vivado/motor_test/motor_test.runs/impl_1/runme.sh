...
HD_PWD='C:/Users/vince/Desktop/Vivado/motor_test/motor_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log servo_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source servo_top.tcl -notrace
