...
HD_PWD='C:/Users/vince/Desktop/Vivado/exam2/exam2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log exam2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source exam2.tcl -notrace
